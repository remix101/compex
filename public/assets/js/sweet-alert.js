...
(function() {
   ...
   */
    ...
    function initialize() {
        var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> <div class="icon info"></div> <div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="icon custom"></div> <h2>Title</h2><p>Text</p><button class="btn cancel" tabIndex="2">Cancel</button><button class="btn confirm" tabIndex="1">OK</button></div>',
            ...
            switch (e.type) {
                ...
                case ("click"):
                    if (targetedConfirm && doneFunctionExists && modalIsVisible) {
                        params.doneFunction(targetedConfirm);
                    }
                    closeModal();
                    break;
            }
   ...
   */
    ...
    function setParameters(params) {
        ...
        if (params.showCancelButton) {
            ...
            $($cancelBtn).addClass(params.cancelButtonClass);
        } else {
            hide($cancelBtn);
        }
        ...
        $($confirmBtn).addClass(params.confirmButtonClass);
