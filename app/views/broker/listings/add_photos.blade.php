...
<div class="container">
    <div class="business_create">
        ...
        <form id="w0" action="{{ url('broker/listings/'.$listing->id.'/photos') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <a type="preview" class="btn btn-success" href="{{ url('broker/listings/preview/'.$listing->id) }}">Preview</a>
