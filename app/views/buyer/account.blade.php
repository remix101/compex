            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" maxlength="17" class="form-control" value="{{ $user->buyer->phone_number }}" name="phone_number" id="inputPhone" placeholder="Use international format, e.g. +234 809 901 9404">
                        </div>
                    </div>
                    <div class="form-group">
