...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a class="btn green pull-right" href="{{ url('buyer/feature') }}">
        ...
        <div class="col-md-12">
            ...
            <div class="">
                <table class="table table-responsive responsive able-striped table-hover table-bordered" id="table_adverts">
                    ...
                    <tbody>
                        <?php $ids = array(); ?>
                        @foreach($user->buyer->adverts as $i => $a)
                        <tr>
                            <?php $ids[$i + 1] = $a->id ?>
                            <td>{{ $i + 1 }}</td>
                            ...
                            <td>
                                <span>
                                    <a class="btn btn-xs default" href="{{ url('buyer/adverts/edit/'.$a->id) }}"> <i class="fa fa-ban"></i> Edit</a><a class="delete btn btn-xs red" href="javascript:;"> <i class="fa fa-trash-o"></i> Delete </a>
                                </span>
                            </td>
                        </tr>
                        @endforeach
...
<script type="text/javascript">  
    ...
    var TableEditable = function () {
        ...
        var handleTable = function () {
            ...
            $.ajax(
                {
                    url: '{{ url("buyer/adverts/delete/").'/'}}' + ids[aData[0]],
                    method: 'delete',
