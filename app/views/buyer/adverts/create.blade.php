...
<div class="container">
    <div class="row">
        <form role="form" action="{{ url('buyer/adverts/create') }}" method="post" class="form-horizontal">
            @if(isset($success))
                ...
                <div class="form-group required">
                    ...
                    <div class="col-md-9">
                        <select id="country" class="form-control" name="country">
                            ...
                            <option value="{{ $c->id }}"{{ $user->buyer != null ? ($user->buyer->country == $c->id ? 'selected' : '') : '' }}>{{$c->name}}</option>
                            @endforeach
                        </select>
