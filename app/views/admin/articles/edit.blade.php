...
<div class="container">
    <div class="row">
        <form role="form" action="{{ url('admin/articles/edit/'.$article->id) }}" method="post" class="form-horizontal">
            @if(isset($success))
            ...
            <div class="col-md-12">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">                            
                            <input type="text" name="title" placeholder="Enter a title for this article" class="form-control" id="heading" value="{{ $article->title }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-2">Content</label>
                        <div class="col-md-10">
                            <textarea class="wysihtml5 form-control" name="html" rows="6">{{ $article->html }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group last" style="margin-left:2em">
                        <div class="col-md-offset-2 checkbox-list">
                            <label class="checkbox" for="description">
                                <input type="checkbox" checked value="1" name="published"> Published</label>
                        </div>
                    </div>
                </div>
                <div class="form-footer">
                    <div class="col-md-offset-2">
                        <a class="btn btn-default" href="{{ url('admin/articles') }}"> Return to Articles</a>
