    ...
    <div class="row search">
        ...
        <div class="col-sm-12 col-md-9 col-lg-9">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="headline tiny">
                        <h3>Viewing business listings in {{ $country->name }}</h3>
                    </div>
                    <!-- headline -->
                </div>
                <!-- col -->
            ...
            <div class="row ajaxrow">                
                    ...
                    <a href="{{ $listing->url }}">
                        <div class="blog-article">
                            ...
                            <div class="blog-article-details blog-article-details_with-more text-center">
                                <h5><a href="http://cx.dev.ephyros.com/business/view/69">{{ $listing->heading }}</a></h5>
                ...
                @else
                <div class="col-sm-12">
                    <h4 class="text-center">No listings found for region "{{ $country->name }}". Please try again</h4>
                </div>
                @endif
            </div>
        </div>
