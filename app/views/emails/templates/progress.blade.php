                                        ...
                                        <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                            <tr>
                                                ...
                                                <td class="pull-right mobile-header-padding-right" style="color: #4d4d4d;">
                                                    ...
                                                    <a href="{{ url('rss') }}"><img width="40" height="47" src="http://s3.amazonaws.com/swu-filepicker/hR33ye5FQXuDDarXCGIW_social_10.gif" alt="rss" /></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </center>
                ...
                <td align="center" valign="top" width="100%" class="content-padding">
                    <center>
                        <table cellspacing="0" cellpadding="0" width="600" class="w320">
                            <tr>
                                <td class="header-lg">
                                    <h2>Welcome to CompanyExchange</h2>
                                    <h4>Please verify your CompanyExchange account</h4>
                                </td>
                            </tr>
                            <tr>
                                <td class="free-text">
                                    To ensure the safety of buyers, we require our sellers to verify their accounts. Please click the link below to verify your account
                                </td>
                            </tr>
                            @if(isset($password_confirmation))
                            <tr>
                                <td class="free-text">
                                    <strong>Please note your temporary password: {{$password_confirmation}}</strong>
                                </td>
                            </tr>
                            @endif
                            <tr>
...
<![endif]--><a href="{{ url('users/verify/'.$user_id.'/'.$verification_code) }}"
