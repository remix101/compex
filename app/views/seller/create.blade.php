...
<div class="container">
    <div class="site-signup">
        ...
        <form id="form-signup" action="{{ url('sellers/create') }}" method="post" role="form">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="well">
                        <div id="social-signup" class="auth-clients text-center">
                            ...
                            <ul class="list-unstyled list-inline">
                                <li><a class="btn btn-default ce-auth-btn ce-auth-btn_facebook" href="{{ url('auth/facebook/seller') }}"><i class="ce-auth-btn__icon fa fa-facebook"></i>facebook</a></li>
                                <li><a class="btn btn-default ce-auth-btn ce-auth-btn_linkedin" href="{{ url('auth/yahoo/seller') }}"><i class="ce-auth-btn__icon fa fa-yahoo"></i>yahoo</a></li>
                                <li><a class="btn btn-default ce-auth-btn ce-auth-btn_google" href="{{ url('auth/google/seller') }}"><i class="ce-auth-btn__icon fa fa-google"></i>google</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="form-group required">
                    ...
                    <div class="form-group required">
                        ...
                        <select class="form-control" name="role_id" id="accountType">
                            ...
                            @if($role->name != 'admin')
                            <option value="{{$role->id}}" {{ $role->name == 'seller' ? 'selected' : '' }}>{{ ucwords($role->name) }}</option>
                            @endif
                            @endforeach
                        </select>
                        <p class="help-block help-block-error"></p>
