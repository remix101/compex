...
<div class="container">
    <div class="business_create">
        ...
        <form id="w0" action="{{ url('sellers/listings/create') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group required">
                                    ...
                                    <select id="country" class="form-control" name="country">
                                        ...
                                        <option value="{{ $c->id }}"{{ $user->seller->country == $c->id ? 'selected' : '' }}>{{$c->name}}</option>
                                        @endforeach
                                    </select>
                                    <div class="help-block"></div>
                                </div>
            ...
            <div class="well">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input id="employee_no" min="0" type="number" value="{{ Input::old('employee_no') }}" placeholder="Number of employees" class="form-control" name="employee_no">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-4">
