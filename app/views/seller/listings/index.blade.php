                ...
                <table class="table table-responsive responsive able-striped table-hover table-bordered" id="table_listings">
                    <thead>
                        <tr>
                            ...
                            <th><i class="fa fa-bar-chart"></i> Total Views</th>
                            <th>  </th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $ids = array(); ?>
                        @foreach($user->seller->listings as $i => $l)
                        <tr>
                            <?php $ids[$i + 1] = $l->id ?>
                            <td>{{ $i + 1 }}</td>
                            ...
                            <td>
                                <span>
                                    <a class="btn btn-xs default" target="_blank" href="{{ url('seller/listings/preview/'.$l->id) }}"><i class="fa fa-eye"></i> Preview</a>
                                    <a class="btn btn-xs default" href="{{ url('seller/listings/edit/'.$l->id) }}"> <i class="fa fa-ban"></i> Edit</a><a class="delete btn btn-xs red" href="javascript:;"> <i class="fa fa-trash-o"></i> Delete </a>
                                </span>
                            </td>
                        </tr>
                        @endforeach
...
<script type="text/javascript">  
    ...
    var TableEditable = function () {
        ...
        var handleTable = function () {
            ...
            $.ajax(
                {
                    url: '{{ url("seller/listings/delete/").'/'}}' + ids[aData[0]],
                    method: 'delete',
