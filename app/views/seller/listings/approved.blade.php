...
@section('title', 'Approved Businesses')
        ...
        <div class="col-md-12">
            ...
            <div class="">
                <table class="table table-responsive responsive able-striped table-hover table-bordered" id="table_listings">
                    ...
                    <tbody>
                        <?php $ids = array(); ?>
                        @foreach($user->seller->listings()->approved()->get() as $i => $l)
                        <tr>
                            <?php $ids[$i + 1] = $l->id ?>
                            <td>{{ $i + 1 }}</td>
                            ...
                            <td>
                                <span>
                                    <a class="btn btn-xs default" href="{{ url('seller/listings/preview/'.$l->id) }}"><i class="fa fa-eye"></i> Preview</a>
